...
@interface UIScrollView (Definite)
...
@property (readonly, nonatomic) NTESScrollViewDirection scrolling;
@property (readonly, nonatomic) NTESScrollViewDirection distance;
//: @property (readonly, nonatomic) NTESScrollViewDirection horizontalScrollingDirection;
@property (readonly, assign, nonatomic) NTESScrollViewDirection more;
