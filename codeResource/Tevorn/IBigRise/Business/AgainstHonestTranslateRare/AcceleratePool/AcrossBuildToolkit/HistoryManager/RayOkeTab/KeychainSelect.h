...
@interface KeychainSelect : NSObject
...
@property (nonatomic, copy, nullable) id<NSCoding> originalObject;
...
@property (nonatomic, copy, nullable) NSData *color;
...
@property (nonatomic, copy, nullable) NSString *holderAgreeProcess;



/** kSecAttrLabel */
//: @property (nonatomic, copy, nullable) NSString *label;
@property (nonatomic, copy, nullable) NSString *fit;


/** kSecAttrService */
//: @property (nonatomic, copy, nullable) NSString *service;
@property (nonatomic, copy, nullable) NSString *ground;

/** kSecAttrSynchronizable */
//: @property (nonatomic) SAMKeychainQuerySynchronizationMode synchronizationMode;
@property (nonatomic) SAMKeychainQuerySynchronizationMode end;
...
- (nullable NSArray<NSDictionary<NSString *, id> *> *)messageAll:(NSError **)error;
