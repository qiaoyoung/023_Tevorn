...
@property (nonatomic, assign) BOOL script;
...
@property (nonatomic, assign) SGCornerLoaction seat;

/// SeeView 背景色，默认为：[[UIColor blackColor] colorWithAlphaComponent:0.5]
//: @property (nonatomic, strong) UIColor *color;
@property (nonatomic, strong) UIColor *output;

/// 扫描线每次移动的步长，默认为：3.5f
//: @property (nonatomic, assign) CGFloat scanlineStep;
@property (nonatomic, assign) CGFloat commitGravity;
...
@property (nonatomic, assign) CGFloat hint;

/// 辅助扫描框的颜色，默认为：[UIColor whiteColor]
//: @property (nonatomic, strong) UIColor *borderColor;
@property (nonatomic, strong) UIColor *popConfirm;

/// 辅助扫描边角长度，默认为：20.0f
//: @property (nonatomic, assign) CGFloat cornerLength;
@property (nonatomic, assign) CGFloat lengthUser;

/// 辅助扫描边角颜色，默认为：[UIColor greenColor]
//: @property (nonatomic, strong) UIColor *cornerColor;
@property (nonatomic, strong) UIColor *scienceLaboratory;

/// 扫描线
//: @property (nonatomic, copy) NSString *scanline;
@property (nonatomic, copy) NSString *monitorStepNecessary;
