...
#import "FoundationAfterProper.h"

//: @interface SGScanCode : NSObject
@interface FullMoon : NSObject
/// 类方法创建
/// 开启扫描
//: - (void)startRunning;
- (void)authority;

@property (nonatomic, assign) double abstractNumber;

/// 采样缓冲区代理
//: @property (nonatomic, weak) id<SGScanCodeSampleBufferDelegate> sampleBufferDelegate;
@property (nonatomic, weak) id<ReflectDefinite> channel;
@property (nonatomic, strong) NSMutableArray *advantageDisableArray;

/// 扫描二维码数据代理
//: @property (nonatomic, weak) id<SGScanCodeDelegate> delegate;
@property (nonatomic, weak) id<FoundationAfterProper> sweepResignsed;
...
@property (nonatomic, assign) double kaSum;
@property (nonatomic, strong) NSMutableArray *stayArray;
/// 扫描区域，以屏幕右上角为坐标原点，取值范围：0～1，默认为整个屏幕
//: @property (nonatomic, assign) CGRect rectOfInterest;
@property (nonatomic, assign) CGRect presentation;
//: @end
@property (nonatomic, assign) double flexibleSum;
@property (nonatomic, assign) CGRect shouldRect;
