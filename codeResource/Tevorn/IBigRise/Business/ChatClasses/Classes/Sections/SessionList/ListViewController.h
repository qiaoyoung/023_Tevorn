...
@interface ListViewController : UIViewController<UITableViewDataSource,UITableViewDelegate,NIMLoginManagerDelegate,NIMConversationManagerDelegate>
/**
 *  会话列表tableView
 */
@property (nonatomic, assign) double patentSum;
@property (nonatomic, strong) NSString *commentApplicationName;

@property (nonatomic, strong) NSString *discourtesyName;

//: @end
@property (nonatomic, strong) UIImageView *cube;
...
- (void)hour:(NIMRecentSession *)recent
             //: atIndexPath:(NSIndexPath *)indexPath;
             moon:(NSIndexPath *)indexPath;
/**
 *  cell显示的会话名
 *
 *  @param recent 最近会话
...
@property (nonatomic,assign) BOOL afterDatabase;

@property (nonatomic, assign) double entireCount;
/**
 *  最近会话集合
 */
...
@property (nonatomic,strong) UITableView *carrierView;
@property (nonatomic, strong) NSString *againName;
@property (nonatomic, assign) NSInteger reinTotal;
@property (nonatomic,strong) UITableView *pressed;
@property (nonatomic, assign) double primaTotal;
