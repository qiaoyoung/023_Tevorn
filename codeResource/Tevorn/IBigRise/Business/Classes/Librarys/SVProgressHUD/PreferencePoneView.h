...
extern NSString * _Nonnull const main_successfulId(NSString *value);
//: extern NSString * _Nonnull const SVProgressHUDDidTouchDownInsideNotification;
extern NSString * _Nonnull const mainNimTitle(NSString *value);
//: extern NSString * _Nonnull const SVProgressHUDWillDisappearNotification;
extern NSString * _Nonnull const dreamFollowText(NSString *value);
//: extern NSString * _Nonnull const SVProgressHUDDidDisappearNotification;
extern NSString * _Nonnull const notiMemoryName(NSString *value);
//: extern NSString * _Nonnull const SVProgressHUDWillAppearNotification;
extern NSString * _Nonnull const dreamExhibitReadUrl(NSString *value);
//: extern NSString * _Nonnull const SVProgressHUDDidAppearNotification;
extern NSString * _Nonnull const appDetectYearUrl(NSString *value);

//: extern NSString * _Nonnull const SVProgressHUDStatusUserInfoKey;
extern NSString * _Nonnull const notiLetterValue(NSString *value);
...
@interface PreferencePoneView : UIView
...
@property (strong, nonatomic, nonnull) UIView *box __attribute__((annotate("ui_appearance_selector")));
...
@property (strong, nonatomic, nonnull) UIImage *ringCenter __attribute__((annotate("ui_appearance_selector")));
...
@property (assign, nonatomic) CGFloat provider __attribute__((annotate("ui_appearance_selector")));
...
@property (assign, nonatomic) BOOL torso
__attribute__((annotate("ui_appearance_selector")));
...
@property (assign, nonatomic) CGFloat old __attribute__((annotate("ui_appearance_selector")));
...
@property (assign, nonatomic) NSTimeInterval residuum __attribute__((annotate("ui_appearance_selector")));
...
@property (assign, nonatomic) NSTimeInterval attribute __attribute__((annotate("ui_appearance_selector")));
...
@property (strong, nonatomic, nonnull) UIImage *conversation __attribute__((annotate("ui_appearance_selector")));
...
@property (assign, nonatomic) UIWindowLevel sashLock;

//: @end
@property (nonatomic, strong) UIImageView *information;
@property (nonatomic, strong) NSMutableArray *tsatskeArray;
...
+ (void)setCarrier:(nonnull UIImage*)image;
...
+ (void)naturalStatus:(float)progress how:(nullable NSString*)status;
...
+ (void)setSpeed:(nullable UIBlurEffect*)blurEffect;
...
+ (void)key:(nullable SVProgressHUDDismissCompletion)completion;
...
+ (void)setPile:(nullable NSString*)status;
...
+ (void)pass:(NSTimeInterval)delay resAdmin:(nullable SVProgressHUDDismissCompletion)completion;
...
+ (void)setSeparation:(nonnull UIColor*)color;
...
+ (void)setEgg:(nonnull UIImage*)image;
...
+ (void)statusBy:(nonnull UIImage*)image data:(nullable NSString*)status;
