...
- (UIImage *)separateSubject:(UIImage*)image imageBackgroundSize:(CGSize)size
{
...
+ (UIImage *)darkAges:(UIColor *)color comparable:(CGFloat)radius
{
    //: CGRect rect = CGRectMake(0.0f, 0.0f,radius * 2 + 4, radius * 2 + 4);
    CGRect rect = CGRectMake(0.0f, 0.0f,radius * 2 + 4, radius * 2 + 4);

    //: UIGraphicsBeginImageContextWithOptions(rect.size, NO, 0.0);
    UIGraphicsBeginImageContextWithOptions(rect.manageSize, NO, 0.0);
...
+ (UIImage*)prepareLap:(UIView *)theView
{
