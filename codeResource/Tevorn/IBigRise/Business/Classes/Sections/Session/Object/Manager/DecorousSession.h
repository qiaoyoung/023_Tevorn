...
@interface DecorousSession : NSObject
...
- (AbsTask *)standOut:(NSMutableArray <NIMMessage *> *)messages
                                          ...
                                          simple:(_Nullable NTESMergeForwardProcess)process
                                       //: completion:(_Nullable NTESMergeForwardResult)completion;
                                       force:(_Nullable NTESMergeForwardResult)completion;
