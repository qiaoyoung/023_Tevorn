...
@property (nonatomic, copy) NSString *unshared;
...
@property (nonatomic, assign) NIMLoginClientType pieceOfGround;

@property (nonatomic, copy) NSString *representationTranslate;
...
+ (nullable instancetype)initWithAssetTitle:(NSData *)data;
