...
@interface OutputFeatherAttachment : NSObject<NIMCustomAttachment,HistoryMultiple>

//: @property (nonatomic,assign) CustomWhiteboardFlag flag;
@property (nonatomic,assign) CustomWhiteboardFlag appropriate;
@property (nonatomic,assign) CustomWhiteboardFlag appropriateFlag;
