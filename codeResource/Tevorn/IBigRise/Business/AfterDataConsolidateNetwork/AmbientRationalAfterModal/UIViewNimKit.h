...
@property (nonatomic) CGFloat device;
/**
 * Shortcut for frame.origin
 */
//: @property (nonatomic) CGPoint device_origin;
@property (nonatomic) CGPoint reasonable;
...
@property (nonatomic) CGFloat warningNetwork;
...
@property (nonatomic) CGFloat monthWhiteHistory;
...
@property (nonatomic) CGFloat putUp;

@property (nonatomic) CGPoint on;
...
@property (nonatomic) CGFloat forbidFloat;

@property (nonatomic) CGFloat per;
...
@property (nonatomic) CGFloat adaptor;
//: @property (nonatomic) CGFloat device_left;
@property (nonatomic) CGFloat bedground;
/**
 * Shortcut for frame.size
 */
//: @property (nonatomic) CGSize device_size;
@property (nonatomic) CGSize waterCooler;
...
@property (nonatomic) CGFloat playerPairOfTongs;
