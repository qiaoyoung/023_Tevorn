...
// __CLOSE_PRINT__
//
//  YYAnimatedImageView+Peaceful.m
// ModestGal
//
...
#import "YYAnimatedImageView+Peaceful.h"
//: #import <objc/runtime.h>
#import <objc/runtime.h>

//: @implementation YYAnimatedImageView (iOS14)
@implementation YYAnimatedImageView (Peaceful)
...
+ (void)load {
    ...
    _dispatch_once(&onceToken, ^{
        ...
        method1 = class_getInstanceMethod([self class], @selector(accountBeing:));
...
- (void)accountBeing:(CALayer *)layer {
