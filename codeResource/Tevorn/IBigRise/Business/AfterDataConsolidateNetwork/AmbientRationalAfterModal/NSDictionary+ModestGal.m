...
@implementation NSDictionary (ModestGal)

//: - (NSArray *)nimkit_jsonStringArray: (NSString *)key
- (NSArray *)permission: (NSString *)key
{
...
- (BOOL)globalizeBull: (NSString *)key
{
    //: id object = [self objectForKey:key];
    id object = [self objectForKey:key];
...
- (unsigned long long)quantityro:(NSString *)key
{
    //: id object = [self objectForKey:key];
    id object = [self objectForKey:key];
    //: if ([object isKindOfClass:[NSString class]] ||
...
- (long long)paperLong: (NSString *)key
{
    //: id object = [self objectForKey:key];
    id object = [self objectForKey:key];
    //: if ([object isKindOfClass:[NSString class]] ||
...
- (NSString *)hairTrigger: (NSString *)key
{
    //: id object = [self objectForKey:key];
    id object = [self objectForKey:key];
    //: if ([object isKindOfClass:[NSString class]])
