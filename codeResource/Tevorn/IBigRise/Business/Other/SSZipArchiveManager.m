...
- (NSString *)calculateAppResPath {
    ...
    NSString *resDir = [docuPath stringByAppendingPathComponent:kDuringMonitor];
    ...
    NSString *fileResDir = [[docuPath stringByAppendingPathComponent:@"file"] stringByAppendingPathComponent:kDuringMonitor];
    ...
    NSString *path = [[AppleProjectKit sharedKit].emoticonBundle pathForResource:kDuringMonitor ofType:@".zip"];
    if (!path) {
